...
(function($) {
	$(document).ready(function() {
		...
		//header bi neon motion
		TweenMax.to($('.neon_on'), 2, {opacity: 1, ease: Bounce.easeOut, yoyo: true, repeat: -1});
		TweenMax.to($('.neon_on2'), 2.2, {opacity: 1, ease: Bounce.easeOut, yoyo: true, repeat: -1});

		//bottom inquiry footer fixed
		(function() {
