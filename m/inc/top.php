...
?>
	<!-- sub_visual start -->
    <div class="sub_visual sub_visual<?=$gnb_index?>">
        <p class="sub_ttl"><img src="<?=$root?>/img/sub/sub_title<?=$gnb_index?>.png" alt="" class="w100"></p>
    </div>
	<!-- //sub_visual end -->
	<!-- lnb start -->
	<div class="lnb_wrap">
...
?>
			...
			<div class="lnb_right">
				<a href="#none" class="lnb_btn"></a>
			</div>
		</div>
		<!-- lnb_pop start -->
		<div class="lnb_pop lnb_pop<?=$gnb_index?>">
...
?>
								<li class="<?if($depth2_list['view3_order_css'] == $minor_index){echo ' on';}?>">
									<a href="<?=$depth2_link?>"><?=strip_tags(html_entity_decode($depth2_list['view3_title_01']))?></a>
								</li>
<?
}
?>
			...
			<div class="lnb_pop_bot">
				<a href="tel:1544.6092" class="lnb_inq">가맹문의 1544-6092</a>
				<button type="button" class="lnb_pop_close">닫기</button>
			</div>
		</div>
		<!-- //lnb_pop end -->
	</div>
	<!-- //lnb end -->
	<!-- sub_content start -->
	<div id="content" class="sub_contant">
		<div class="page_title_wrap">
			<p class="page_title"><img src="<?=$root?>/img/sub/page<?=$gnb_index?>_title<?=$minor_index?>.png" alt="<?=$board_list['view3_special_01']?>" class="w100"></p>
			<p class="page_text t_center">
				<?=html_entity_decode($board_list['view3_special_02'])?>
			</p>
		</div>
