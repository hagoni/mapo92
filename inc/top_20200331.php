...
?>
	<!-- sub_visual start -->
	<div class="sub_visual<?=$gnb_index?> sub_visual rel" data-sub-offset="1">
		<div class="sub_visual_bg bg"></div>
		<div class="sub_title_area abs t_center">
			<ul class="sub_title t_center">
<?if($gnb_index == 1) {?>
				<li><img src="<?=$root?>/img/sub/sub_title1_1.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title1_2.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title1_3.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title1_4.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title1_5.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title1_6.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title1_7.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title1_8.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title1_9.png" alt=""></li>
<?} elseif($gnb_index == 2){?>
				<li><img src="<?=$root?>/img/sub/sub_title2_1.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title2_2.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title2_3.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title2_4.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title2_5.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title2_6.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title2_7.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title2_8.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title2_9.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title2_10.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title2_11.png" alt=""></li>
<?} elseif($gnb_index == 3){?>
				<li><img src="<?=$root?>/img/sub/sub_title3_1.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title3_2.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title3_3.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title3_4.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title3_5.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title3_6.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title3_7.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title3_8.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title3_9.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title3_10.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title3_11.png" alt=""></li>
<?} elseif($gnb_index == 4){?>
				<li><img src="<?=$root?>/img/sub/sub_title4_1.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title4_2.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title4_3.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title4_4.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title4_5.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title4_6.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title4_7.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title4_8.png" alt=""></li>
<?} elseif($gnb_index == 5){?>
				<li><img src="<?=$root?>/img/sub/sub_title5_1.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title5_2.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title5_3.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title5_4.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title5_5.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title5_6.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title5_7.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title5_8.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title5_9.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title5_10.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title5_11.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title5_12.png" alt=""></li>
				<li><img src="<?=$root?>/img/sub/sub_title5_13.png" alt=""></li>
<?}?>
			</ul>
		</div>
	</div>
...
?>
	...
	<div class="page_title_area t_center">
		<p class="page_title"><img src="<?=$root?>/img/sub/page<?=$gnb_index?>_title<?=$minor_index?>.png" alt="<?=$board_list['view3_special_01']?>"></p>
		<p class="page_text"><?=html_entity_decode($board_list['view3_special_02'])?></p>
	</div>
	<!-- //page_title_area end -->
